        ...
        function addBlocks(div, data, cellWidth, start) {
            ...
            for (var i = 0; i < data.length; i++) {
                for (var j = 0; j < data[i].series.length; j++) {
                    ...
                    var title = data[i].series[j].title ? data[i].series[j].title  : "Total ";
                    var blockText = data[i].series[j].label ? data[i].series[j].label  : "";;
                    var backgroundColor = data[i].series[j].color ? data[i].series[j].color  : "#6f42c1";
