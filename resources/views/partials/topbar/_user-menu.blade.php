<!--begin::Menu-->
<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-primary fw-bold py-4 fs-6 " style="width: max-content !important" data-kt-menu="true">
    <!--begin::Menu item-->
        ...
        <div class="menu-content d-flex align-items-center px-3">
            ...
            <div class="d-flex flex-column">
                <div class="fw-bolder d-flex align-items-center fs-5">
                    {{ auth()->user()->name }}
                    @php
                        $userJob = auth()->user()->userJob;
                    @endphp
                    @if ($userJob)
                        <span class="badge badge-light-success fw-bolder fs-8 px-2 py-1 ms-2">{{ $userJob->department->name }}</span>
                    @endif
                </div>
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-5">
        <a href="{{ theme()->getPageUrl('my_days_off') }}" class="menu-link px-5">
            {{ __('lang.My Days Off') }}
        </a>
    </div>
    <!--end::Menu item-->
    ...
    <!--begin::Menu item-->
    <div class="menu-item px-5">
        <a href="{{ theme()->getPageUrl('tickets') }}" class="menu-link px-5">
            <span class="menu-text">{{ __('lang.My Incidents') }}</span>
