...
<div class="tab-content" id="TabContent">
    <div class="tab-pane fade show active" id="add-base-point" role="tabpanel">
            ...
            <div class="card-body ">
                ...
                <div class="form-group">
                    <div class="mb-5">
                        ...
                        <select name="client_type_id" id="client_type_id"
                            class="form-select form-select-solid rounded-start-0 border-start filter-table-point" data-control="select2"
                            data-placeholder="Type de client  ... " data-dropdown-parent="#ajax-modal"
                            data-allow-clear="true" data-hide-search="true">
                            <option value="">-- @lang('lang.client_types') --</option>
                            @foreach ($client_types as $type)
                            <option @if ( $loop->index == 0 )
                                selected
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            <div class="mb-5">
                                ...
                                <select name="project_type_id" id="project_type_id"
                                    ...
                                    data-dropdown-parent="#ajax-modal" data-allow-clear="true">
                                    <option value="">-- @lang('lang.client_types') --</option>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="mb-5">
                                ...
                                <select name="version_id" id="version_id_associed"
                                    class="form-select form-select-solid rounded-start-0 border-start"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="mb-5">
                                <label for="type" class="form-label">Pôle</label>
                                <select name="pole" id="pole"
                                    class="form-select form-select-solid rounded-start-0 border-start"
                                    data-control="select2" data-placeholder="Pole ... "
                                    data-dropdown-parent="#ajax-modal" data-allow-clear="true" data-hide-search="true">
                                    <option value="">-- @lang('lang.pole') --</option>
                ...
                <div class="row">
                    <div class="col-md-4 mb-4">
                        ...
                        <select name="niveau" id="level"
                            ...
                            data-placeholder="Niveau  ... " data-allow-clear="true" data-hide-search="true">
                            <option value=""> -- Niveau -- </option>
                            @foreach ($levels as $level)
                            <option value="{{  get_array_value($level,"value")  }}">   {{ get_array_value($level,"text") }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-4 mb-4">
                        <label for="point" class="form-label">@lang('lang.point') </label>
                        <input type="text" name="point" autocomplete="off"
                            class="form-control form-control-solid col-md-3" value="" placeholder="Point value ... ">
                    </div>
                    <div class="col-md-4 mb-4">
                        <label for="point_sup" class="form-label">@lang('lang.point_sup')</label>
                        <input type="text" name="point_sup" autocomplete="off"
                            class="form-control  form-control-solid col-md-3" value=""
                            placeholder="Point multi projet ... ">
                    </div>
                </div>
            </div>
            <div class="card-footer d-flex justify-content-end">
                <button type="button" data-bs-dismiss="modal" aria-label="Close"
                    class="btn btn-light-light btn-sm mr-2 ">
        ...
        <div class="card-footer ">
            <table id="pointClientTypeTable"
                class="table table-row-dashed table-row-gray-200 align-middle table-hover dataTable "></table>
        </div>
    </div>
    <div class="tab-pane fade" id="calcul-other-point-verison" role="tabpanel">
        <form class="form" id="version-other-point-modal-form" method="POST"
            action="{{ url('/suivi/save-point-other-version') }}">
            <div class="card-body ">
                @csrf
                <div class="separator mb-2"></div>
                <div class="row">
                    <div class="form-group col-md-6">
                        <div class="mb-5">
                            ...
                            <select name="version_id_of_calcul" id="version_id_of_calcul"
                                class="form-select form-select-solid rounded-start-0 border-start point-percentage"
                                data-control="select2" data-placeholder="Version  ... "
                                data-dropdown-parent="#ajax-modal" data-allow-clear="true">
                                <option value="">-- @lang('lang.version') --</option>
                                @foreach ($versions as $version)
                                <option value="{{ $version->id }}">{{ $version->title }}</option>
                    ...
                    <div class="form-group col-md-3">
                        <div class="mb-5">
                            ...
                            <select name="montage" id="montage"
                                class="form-select form-select-solid rounded-start-0 border-start point-percentage"
                                data-control="select2" data-placeholder="Montage ... "
                                data-dropdown-parent="#ajax-modal" data-hide-search="true" data-allow-clear="true">
                                <option value="">-- @lang('lang.montage') --</option>
                                @foreach ($montages as $montage)
                                <option value="{{ get_array_value($montage,"value") }}">{{
                                    get_array_value($montage,"text") }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="form-group col-md-3">
                        <div class="mb-5">
                            <h5 class="mb-2">Pole : </h5>
                                <select name="pole" id="pole2"
                                class="form-select form-select-solid rounded-start-0 border-start"
                                data-control="select2" data-placeholder="Pole ... "
                                data-dropdown-parent="#ajax-modal" data-allow-clear="true" data-hide-search="true">
                                <option value="">-- @lang('lang.pole') --</option>
                ...
                <div class="point-value-section">
                    ...
                    <div class="mx-4">
                        <div class="mb-5 form-group col-md-6">
                            ...
                            <input type="text" name="point" id="point" autocomplete="off"
                                class="form-control form-control-solid" placeholder="Point ...." />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row mx-4 ">
                        <div class="form-group col-md-6">
                            <div class="mb-5">
                                ...
                                <select name="version_id_base" id="version_id_base"
                                    class="form-select form-select-solid rounded-start-0 border-start point-percentage"
                                    data-control="select2" data-placeholder="Version de base ... "
                                    data-dropdown-parent="#ajax-modal" data-allow-clear="true">
                                    <option value="">-- @lang('lang.version') --</option>
                                    @foreach ($versions as $version)
                                    <option value="{{ $version->id }}">{{ $version->title }}</option>
                        ...
                        <div class="form-group col-md-6 ">
                            <div class="mb-5">
                                ...
                                <input type="text" name="percentage" id="percentage" autocomplete="off"
                                    class="form-control form-control-solid point-percentage"
                                    placeholder="Pourcentage, ex: 12.5" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="card-footer ">
            <table id="versionsPointCalculTable"
                class="table table-row-dashed table-row-gray-200 align-middle table-hover dataTable "></table>
        </div>
    </div>
</div>
    ...
    $(document).ready(function() {
        ...
        dataTableInstance.pointClientTypeTable = $("#pointClientTypeTable").DataTable({
            ...
            columns:[
                ...
                {data :"pole" , title: 'Pole', "class":"text-center fw-bold text-gray-900"},
