            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    <div class="mb-3 col-md-12">
                        ...
                        <select class="form-select" name="users_validator[]" id="users_validator" data-control="select2"  data-placeholder="Selectionner la personne valideur des congés" data-allow-clear="true" multiple="multiple">
