<x-auth-layout>
    ...
    <!--begin::Heading-->
        ...
        <div class="fv-row mb-10">
            <!--begin::Label-->
            <label class="form-label fs-6 fw-bolder text-dark">Matricule</label>
            <!--end::Label-->

            <!--begin::Input-->
            <input class="form-control form-control-lg form-control-solid" type="number" name="registration_number" autocomplete="off" value="{{ old('registration_number') }}" required autofocus/>
            <!--end::Input-->
        </div>
        <!--end::Input group-->
        ...
        <div class="fv-row mb-10">
            <label class="form-check form-check-custom form-check-solid">
                ...
                <span class="form-check-label fw-bold text-gray-700 fs-6">Se Souvenir de moi
            </span>
            </label>
        </div>
        <!--end::Input group-->
        ...
        <div class="text-center">
            ...
            <button type="submit" id="kt_sign_in_submit" class="btn btn-lg btn-primary w-100 mb-5">
                @include('partials.general._button-indicator', ['label' => trans("lang.signin")])
            </button>
            <!--end::Submit button-->
