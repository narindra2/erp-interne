...
<div class="form-check form-switch form-check-custom mt-2 justify-content-center " title="Afficher le Qrcode du {{ $item->code_detail }}">
    <input class="form-check-input h-20px w-30px" type="checkbox" role="switch" value="1" che
