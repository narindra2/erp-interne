        ...
        <div class="card-body ">
            <div class="d-flex overflow-auto ">
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent  fw-bolder flex-nowrap">
                    <li class="nav-item">
                        <a class="nav-link text-active-primary me-6 " href="#article" data-toggle="ajax-tab"   data-bs-toggle="tab" data-load-url = "{{ url("/items/list") }}">
                           Arlicles
                        </a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary me-6 " href="#info" data-toggle="ajax-tab" data-bs-toggle="tab" data-load-url = "{{ url("/stock/category/tab") }}">
                           Catégories
                        </a>
                    </li>
                </ul>
